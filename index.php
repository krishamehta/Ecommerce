	...
	<div class="header" id="home1">
		<div class="container">
			...
			<div class="cart cart box_1"> 
				<form action="pay.html" method="post" class="last"> 
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						<li><a href="index.php" class="act" style="margin-left: 100px">Home</a></li>	
						<!-- Mega Menu -->
						<li class="dropdown">
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 38000</span> <i class="item_price">Rs 35000</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
											<input type="hidden" name="w3ls_item" value="Mobile Phone1" /> 
											<input type="hidden" name="amount" value="35000.00" />   
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 33000</span> <i class="item_price">Rs 30200</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
											<input type="hidden" name="w3ls_item" value="Mobile Phone2" /> 
											<input type="hidden" name="amount" value="30200.00" />   
											<button type="submit" class="w3ls-cart">Add to cart</button>
										</form>
									</div>
								</div>
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 25000</span> <i class="item_price">Rs 24500</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="single.html">Speakers</a></h5>
										<p><span>Rs 32000</span> <i class="item_price">Rs 25000</i></p>
									<div class="simpleCart_shelfItem">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 18000</span> <i class="item_price">Rs 15000</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 22000</span> <i class="item_price">Rs 18000</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
						...
						<div role="tabpanel" class="tab-pane fade" id="video" aria-labelledby="video-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 88000</span> <i class="item_price">Rs 85000</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 29000</span> <i class="item_price">Rs 28000</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
											<input type="hidden" name="w3ls_item" value="Notebook" /> 
											<input type="hidden" name="amount" value="28000.00" />   
											<button type="submit" class="w3ls-cart">Add to cart</button>
										</form>
									</div>
								</div>
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 1200</span> <i class="item_price">Rs 800</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
						...
						<div role="tabpanel" class="tab-pane fade" id="tv" aria-labelledby="tv-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 95000</span> <i class="item_price">Rs 82000</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
											<input type="hidden" name="w3ls_item" value="Refrigerator" /> 
											<input type="hidden" name="amount" value="82000.00" />   
											<button type="submit" class="w3ls-cart">Add to cart</button>
										</form>
									</div>
								</div>
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 70000</span> <i class="item_price">Rs 68000</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
											<input type="hidden" name="w3ls_item" value="LED Tv"/> 
											<input type="hidden" name="amount" value="68000.00"/>   
											<button type="submit" class="w3ls-cart">Add to cart</button>
										</form>
									</div>
								</div>
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 52000</span> <i class="item_price">51000</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
											<input type="hidden" name="w3ls_item" value="Washing Machine" /> 
											<input type="hidden" name="amount" value="51000.00" />   
											<button type="submit" class="w3ls-cart">Add to cart</button>
										</form>
									</div>
								</div>
						...
						<div role="tabpanel" class="tab-pane fade" id="kitchen" aria-labelledby="kitchen-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>R 46000</span> <i class="item_price">Rs 45000</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 39000</span> <i class="item_price">Rs 35000</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs 25000</span> <i class="item_price">Rs 22000</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
				...
				<section>
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							...
							<div class="modal_body_right_cart simpleCart_shelfItem">
								<p><span>Rs 46000</span> <i class="item_price">450</i></p>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart">
									<input type="hidden" name="add" value="1"> 
									<input type="hidden" name="w3ls_item" value="Mobile Phone1"> 
				...
				<section>
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							...
							<div class="modal_body_right_cart simpleCart_shelfItem">
								<p><span>Rs 96000</span> <i class="item_price">RS 92000</i></p>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart">
									<input type="hidden" name="add" value="1"> 
				...
				<section>
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							...
							<div class="modal_body_right_cart simpleCart_shelfItem">
								<p><span>Rs 28000</span> <i class="item_price">Rs 25000</i></p>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart">
									<input type="hidden" name="add" value="1"> 
							...
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								<div class="banner-wrap">
									<div class="w3agile_special_deals_grid_left_grid1">
										...
										<p>This website is the new mall! We use it for all our electronic needs. Its just great!</p>
										<h4>Krisha Mehta</h4>
									</div>
								</div>
							</article>
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								<div class="banner-wrap">
									<div class="w3agile_special_deals_grid_left_grid1">
										...
										<p>Online Shopping used to be very scary. But not anymore! Thank you Electronic Shop!</p>
										<h4>Yash Kotadia</h4>
									</div>
								</div>
							</article>
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								<div class="banner-wrap">
									<div class="w3agile_special_deals_grid_left_grid1">
										...
										<p>This place has the best discounts ever!</p>
										<h4>Yash Lahoti</h4>
									</div>
								</div>
							</article>
			...
			<div class="agileinfo_new_products_grids">
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<div class="simpleCart_shelfItem">
							<p><span>Rs 52000</span> <i class="item_price">Rs 50000</i></p>
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1"> 
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<div class="simpleCart_shelfItem">
							<p><span>Rs 38000</span> <i class="item_price">Rs 37000</i></p>
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1"> 
								<input type="hidden" name="w3ls_item" value="Black Phone"> 
								<input type="hidden" name="amount" value="37000.00">   
								<button type="submit" class="w3ls-cart">Add to cart</button>
							</form>
						</div>
					</div>
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<div class="simpleCart_shelfItem">
							<p><span>Rs 1500</span> <i class="item_price">Rs 1000</i></p>
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1"> 
	...
	<div class="newsletter">
		<div class="container">
			<div class="col-md-6 w3agile_newsletter_left">
				<h3>Newsletter</h3>
				<p>Stay tuned for the best deals!</p>
			</div>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-3 w3_footer_grid">
					<h3>Contact</h3>
					<p>Contact us for futher information.</p>
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>A/10, Akruti Trade Centre <span>Mumbai.</span></li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">info@example.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>022-25156678</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Information</h3>
